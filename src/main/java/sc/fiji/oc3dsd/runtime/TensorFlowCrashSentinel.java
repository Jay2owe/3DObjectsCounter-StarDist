...
public final class TensorFlowCrashSentinel {
    ...
    /**
     * Locates the Fiji installation directory. FLASH resolves this through its
     * dependency registry; here the two ImageJ properties are enough, since the
     * only thing wanted is the {@code lib/} tree holding the TensorFlow crash
     * marker. Returning null simply means the sentinel does nothing, which is
     * the correct behaviour outside a real Fiji.
     */
    static File resolveFijiDir() {
        String[] candidates = {
                System.getProperty("imagej.dir"),
                System.getProperty("ij.dir"),
                ij.Prefs.getImageJDir(),
        };
